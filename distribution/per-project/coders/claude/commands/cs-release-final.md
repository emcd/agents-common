---
allowed-tools: Bash(echo:*), Bash(gh run list:*), Bash(gh run watch:*), Bash(git add:*), Bash(git branch:*), Bash(git checkout:*), Bash(git cherry-pick:*), Bash(git commit:*), Bash(git log:*), Bash(git pull:*), Bash(git rm:*), Bash(git status), Bash(git tag:*), Bash(grep:*), Bash(hatch --env develop run:*), Bash(hatch version:*), Bash(ls:*), LS, Read
