---
allowed-tools: Bash(git diff), Bash(git status), Bash(hatch --env develop run:*), Edit, Glob, Grep, LS, MultiEdit, Read, Write, mcp__pyright__diagnostics, mcp__pyright__hover, mcp__pyright__references
