---
allowed-tools: Bash(date:*), Bash(echo:*), Bash(gh run list:*), Bash(gh run view:*), Bash(gh run watch:*), Bash(git add:*), Bash(git commit:*), Bash(git pull:*), Bash(git push:*), Bash(git status), Bash(git tag:*), Bash(grep:*), Bash(hatch --env develop run:*), Bash(hatch version:*), Bash(ls:*), LS, Read
