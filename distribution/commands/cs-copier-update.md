---
allowed-tools: Bash(copier:*), Bash(git add:*), Bash(git rm:*), Bash(git status), Bash(grep:*), Bash(hatch --env develop run make-all), Bash(rg:*), Edit, Glob, Grep, LS, MultiEdit, Read, TodoWrite, Write
