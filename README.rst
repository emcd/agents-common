...
Or, install via `pipx <https://pipx.pypa.io/latest/how-to/install-pipx.html>`_:
...
* **Multi-Tool Support**: Support Claude Code, Opencode, Codex, and future AI development environments
