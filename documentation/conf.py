...
def _import_version( ):
    ...
    module = import_module( 'agentsmgr' )
...
linkcheck_ignore = [
    ...
    r'https://emcd\.github\.io/agents-common/.*',
    ...
    r'https://github\.com/emcd/agents-common',
    r'https://github\.com/emcd/agents-common/.*',
    # Package does not exist during initial development.
    r'https://pypi.org/project/emcd-agents/',
