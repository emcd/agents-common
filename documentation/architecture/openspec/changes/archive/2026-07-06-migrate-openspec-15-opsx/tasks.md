...
- [x] 1.1 Create curated `opsx-propose.md` under `defaults/contents/skills/opsx-propose.md` (portable across coders, stores guidance removed)
- [x] 1.2 Create curated `opsx-apply.md` under `defaults/contents/skills/opsx-apply.md` (stores guidance removed)
- [x] 1.3 Create curated `opsx-archive.md` under `defaults/contents/skills/opsx-archive.md` (stores guidance removed)
- [x] 1.4 Create curated `opsx-explore.md` under `defaults/contents/skills/opsx-explore.md` (stores guidance removed)
- [x] 1.5 Create curated `opsx-sync.md` under `defaults/contents/skills/opsx-sync.md` (stores guidance removed)
...
- [x] 4.1 Rewrite `template/documentation/agents/openspec.md` to reference OPSX skills (`opsx-propose`, `opsx-apply`, etc.) and CLI state queries (`openspec list`, `openspec status`, `openspec instructions`, `openspec validate --all --strict`)
