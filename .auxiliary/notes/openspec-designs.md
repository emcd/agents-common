...
### Deferred Items
- [DEFERRED] Update openspec/AGENTS.md with standards references (pending discussion - AGENTS.md is generated by upstream)

### Migration
- [ ] Run batch migration using prompts/migrate-designs-to-openspec.md
  - Migrates documentation/prd.rst → openspec/specs/*/spec.md
  - Converts documentation/architecture/designs/*.rst → openspec/specs/*/design.md
  - Uses rst2myst or pandoc for initial conversion, then LLM cleanup
  - Validates with `openspec validate --specs --strict`

### Validation
- [ ] Test Openspec workflow with existing spec:
  - [ ] Create change proposal with /openspec:proposal
  - [ ] Implement with /openspec:apply
  - [ ] Archive and verify delta merging

### Integration Testing (After Migration)
- [ ] Test new capability workflow (create, implement, validate)
- [ ] Test change proposal workflow (propose, implement, archive, verify merge)
- [ ] Test cross-project with python-project-common template
- [ ] Validate slash command integration and workflow consistency
